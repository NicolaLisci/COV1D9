...
!function (n, t) {
    ...
    var e = [], r = function (t, o, i) {
        ...
        plugins: {}, noConflict: function () {
            return o.planetaryjs = i, c
        }, loadPlugin: function (n) {
            e.push(n)
        }, planet: function () {
            var t = [], o = {onInit: [], onDraw: [], onStop: []}, i = {
                plugins: {}, draw: function (n) {
                    u(i, n, t, o)
                }, onInit: function (n) {
                    o.onInit.push(n)
                }, onDraw: function (n) {
    ...
    return c.plugins.topojson = function (t) {
        return function (o) {
            o.plugins.topojson = {}, o.onInit(function (i) {
                if (t.world) o.plugins.topojson.world = t.world, setTimeout(i, 0); else {
        ...
        return function (t) {
            t.onDraw(function () {
                t.withSavedContext(function (o) {
                    o.beginPath(), t.path.context(o)({type: "Sphere"}), o.fillStyle = n.fill || "black", o.fill()
                })
            })
        }
        ...
        return function (o) {
            ...
            o.onInit(function () {
                var r = o.plugins.topojson.world, l = r.objects.countries, a = n.type || "internal";
                i = t.mesh(r, l, e[a])
            }), o.onDraw(function () {
                o.withSavedContext(function (t) {
        ...
        n = n || {};
        var t = n.topojson || {}, o = n.oceans || {}, i = n.land || {}, e = n.borders || {};
        return function (n) {
        ...
        return function (n) {
            n.plugins.pings = {add: i}, n.onDraw(function () {
                var t = new Date;
        ...
        t = t || {};
        var o = function () {
            }, i = t.onZoomStart || o, e = t.onZoomEnd || o, r = t.onZoom || o, l = t.afterZoom || o, a = t.initialScale,
        ...
        t = t || {};
        var o = function () {
        }, i = t.onDragStart || o, e = t.onDragEnd || o, r = t.onDrag || o, l = t.afterDrag || o;
        return function (t) {
            t.onInit(function () {
                var o = n.behavior.drag().on("dragstart", i.bind(t)).on("dragend", e.bind(t)).on("drag", function () {
                    r.call(t);
                    var o = n.event.dx, i = n.event.dy, e = t.projection.rotate(), a = t.projection.scale(),
                        u = n.scale.linear().domain([-1 * a, a]).range([-90, 90]), c = u(o), s = u(i);
