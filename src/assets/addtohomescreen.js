    ...
    */
    ...
    ath.intl = {
        ...
        it_it: {
            ...
            android: 'Per aggiungere questa web app alla schermata iniziale, premi <strong id="install">Installa</strong>',
        },
    ...
    ath.defaults = {
        ...
        onAdd: true,				// when the application is launched the first time from the homescreen (guesstimate)
    ...
    ath.Class.prototype = {
        ...
        show: function (force) {
            ...
            if (this.options.icon && this.applicationIcon) {
                ...
                this.img.src = '/assets/cov1d-icon-app.png';
